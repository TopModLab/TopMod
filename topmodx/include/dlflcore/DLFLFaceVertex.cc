...
DLFLFaceVertex::DLFLFaceVertex(bool bf)
	: vertex(nullptr), normal(), color(1), texcoord(), backface(bf), index(0)
...
DLFLFaceVertex::DLFLFaceVertex(const DLFLFaceVertex& dfv)
	...
	fvpNext(nullptr), fvpPrev(nullptr), fvtType(dfv.fvtType), auxcoords(dfv.auxcoords), auxnormal(dfv.auxnormal)
{
