	...
	bool set_type)
{
	...
	DLFLFaceVertexPtr fvptr1 = nullptr, fvptr2 = nullptr;
	DLFLFaceVertexPtr fvptr1b = nullptr, fvptr2b = nullptr;
...
DLFLEdgePtr insertEdgeCoFacial(
	DLFLObjectPtr obj,
	DLFLFaceVertexPtr fvptr1, DLFLFaceVertexPtr fvptr2,
	bool set_type)
{
...
DLFLFacePtrArray deleteEdge(DLFLObjectPtr obj, DLFLEdgePtr edgeptr, bool cleanup)
{
	...
	if (f1 != f2)
	{
		...
		DLFLFaceVertexPtr next, temp = nullptr;
		temp = f2->front();
		while (temp != fvpV2)
		{
			next = temp->next();
