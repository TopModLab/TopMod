...
void resolvePolygon(
	const Vector3dArray& poly, const Vector3d& xref, const Vector3d& yref,
...
void reconstructPolygon(
	Vector3dArray& poly, const Vector3d& xref, const Vector3d& yref,
...
void hermiteInterpolate(
	const Vector3d& p1,
	const Vector3d& v1, const Vector3d& p2, const Vector3d& v2,
...
Vector3d planarProjectAndIntersect(
	const Vector3d& _p00, const Vector3d& _p01,
...
Vector3d intersectCoplanarLines(
