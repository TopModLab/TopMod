...
public:
	...
	DLFLFacePtr getFacePtr() const { if (fpFPtr) return fpFPtr; else return nullptr; };
	...
	void reset()
	{
		vertex = nullptr; normal.reset(); //color = 1.0; texcoord.reset();
		epEPtr = nullptr; fpFPtr = nullptr;
	...
	* Returns this facevertex if EdgePtr is nullptr */
...
public:
	...
	// Flag indicating this is part of a "back" face
