...
public:
	...
	// Default constructor
	DLFLEdge()
		: fvpV1(nullptr), fvpV2(nullptr), etType(ETNormal), auxcoords(), auxnormal(), midpoint(), normal(), flags(0)
	{
		assignID();
	}
	...
	*/
	...
	// Returns nullptr if edge is not adjacent to given face
	...
	DLFLFaceVertexPtr getOtherFaceVertexPtr(DLFLFaceVertexPtr fvptr)
	{
		...
		// Returns nullptr if given DLFLFaceVertexPtr is not found in this edge
	...
	*/
	...
	// If any of the FaceVertexPtr fields are nullptr set it to the given FaceVertexPtr
	void setNullFaceVertexPtr(DLFLFaceVertexPtr fvptr)
	{
		if (fvpV1 == nullptr) fvpV1 = fvptr;
		else if (fvpV2 == nullptr) fvpV2 = fvptr;
	}

	// If any of the FaceVertexPtr fields matches the given FaceVertexPtr, set it to nullptr
	void resetFaceVertexPtr(DLFLFaceVertexPtr fvptr)
	{
		if (fvpV1 == fvptr) fvpV1 = nullptr;
		else if (fvpV2 == fvptr) fvpV2 = nullptr;
	}
