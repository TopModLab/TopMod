...
DLFLFacePtr duplicateFace(
	DLFLObjectPtr obj, DLFLFacePtr fptr,
...
DLFLFacePtr duplicateFace(
	DLFLObjectPtr obj, DLFLFacePtr fptr,
	const Vector3d& dir, double offset, double rot, double sf)
{
	// Duplicate given face, offsetting, scaling and rotating if necessary
	DLFLFacePtr endface = nullptr;
...
DLFLFacePtr duplicateFacePlanarOffset(
	DLFLObjectPtr obj, DLFLFacePtr fptr,
	double offset, double rot, double thickness, bool fractionalthickness)
{
	// Duplicate the given face, use face normal for direction of offset
