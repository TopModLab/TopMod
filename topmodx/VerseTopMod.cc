...
void VerseTopMod::connectLocalhost()
{
	...
	// verse_callback_set((void *)verse_send_connect_accept, (void *)callback_accept_connect, nullptr);
	// verse_callback_set((void *)verse_send_node_create,	  (void *)callback_node_create, nullptr);
	//
	// /* Kick off program by connecting to Verse host on local machine. */
	// verse_send_connect("TopMod", "password", "localhost", nullptr);
	// while(TRUE)
