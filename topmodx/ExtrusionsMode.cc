...
QDoubleSpinBox *ExtrusionsMode::createDoubleSpinBox(
...
void ExtrusionsMode::setupDooSabinExtrude()
{
	...
	dooSabinLengthSpinBox = createDoubleSpinBox(
		mDooSabinExtrudeLayout, dooSabinLengthLabel, tr("Length"),
	...
	dooSabinTwistSpinBox = createDoubleSpinBox(
		mDooSabinExtrudeLayout, dooSabinTwistLabel, tr("Twist"),
		-5, 5, .01, 0.0, 3, 1, 0);
	...
	dooSabinScaleSpinBox = createDoubleSpinBox(
		mDooSabinExtrudeLayout, dooSabinScaleLabel, tr("Scale"),
	...
	dooSabinSegmentsSpinBox = createDoubleSpinBox(
		mDooSabinExtrudeLayout, dooSabinSegmentsLabel, tr("Segments"),
		1, 50, 1, 1, 0, 3, 0);
...
void ExtrusionsMode::setupCubicalExtrude()
{
	...
	cubicalLengthSpinBox = createDoubleSpinBox(
		mCubicalExtrudeLayout, cubicalLengthLabel, tr("Length"),
		-100.0, 100.0, 0.1, 2.0, 3, 0, 0);
	connect(cubicalLengthSpinBox, SIGNAL(valueChanged(double)), this, SLOT(setLength(double)));
	//rotation
	cubicalRotationLabel = new QLabel(this);
	cubicalRotationSpinBox = createDoubleSpinBox(
		mCubicalExtrudeLayout, cubicalRotationLabel, tr("Rotation"),
		0, 360, 1, 0.0, 3, 1, 0);
	connect(cubicalRotationSpinBox, SIGNAL(valueChanged(double)), this, SLOT(setRotation(double)));
	//scale
	cubicalScaleLabel = new QLabel(this);
	cubicalScaleSpinBox = createDoubleSpinBox(
		mCubicalExtrudeLayout, cubicalScaleLabel, tr("Scale"),
		0.0, 10.0, 0.01, 1.0, 3, 2, 0);
	connect(cubicalScaleSpinBox, SIGNAL(valueChanged(double)), this, SLOT(setScale(double)));
	//segments
	cubicalSegmentsLabel = new QLabel(this);
	cubicalSegmentsSpinBox = createDoubleSpinBox(
		mCubicalExtrudeLayout, cubicalSegmentsLabel, tr("Segments"),
		1, 50, 1, 1, 0, 3, 0);
...
void ExtrusionsMode::setupDodecahedralExtrude()
{
	...
	dodecahedralLength1SpinBox = createDoubleSpinBox(
		mDodecahedralExtrudeLayout, dodecahedralLength1Label, tr("Length 1"),
	...
	dodecahedralLength2SpinBox = createDoubleSpinBox(
		mDodecahedralExtrudeLayout, dodecahedralLength2Label, tr("Length 2"),
	...
	dodecahedralLength3SpinBox = createDoubleSpinBox(
		mDodecahedralExtrudeLayout, dodecahedralLength3Label, tr("Length 3"),
	...
	dodecahedralAngleSpinBox = createDoubleSpinBox(
		mDodecahedralExtrudeLayout, dodecahedralAngleLabel, tr("Angle"),
		0.0, 180.0, 0.1, 40.0, 3, 3, 0);
...
void ExtrusionsMode::setupIcosahedralExtrude()
{
	...
	icosahedralLength1SpinBox = createDoubleSpinBox(
		mIcosahedralExtrudeLayout, icosahedralLength1Label, tr("Length 1"),
		0.0, 100.0, 0.1, 0.5, 3, 0, 0);
	...
	icosahedralLength2SpinBox = createDoubleSpinBox(
		mIcosahedralExtrudeLayout, icosahedralLength2Label, tr("Length 2"),
	...
	icosahedralLength3SpinBox = createDoubleSpinBox(
		mIcosahedralExtrudeLayout, icosahedralLength3Label, tr("Length 3"),
	...
	icosahedralAngleSpinBox = createDoubleSpinBox(
		mIcosahedralExtrudeLayout, icosahedralAngleLabel, tr("Angle"),
		0.0, 180.0, 0.1, 50.0, 3, 3, 0);
	...
	icosahedralSegmentsSpinBox = createDoubleSpinBox(
		mIcosahedralExtrudeLayout, icosahedralSegmentsLabel, tr("Segments"),
		1, 50, 1, 1, 0, 4, 0);
...
void ExtrusionsMode::setupOctahedralExtrude()
{
	...
	octahedralLengthSpinBox = createDoubleSpinBox(
		mOctahedralExtrudeLayout, octahedralLengthLabel, tr("Length"),
		-100.0, 100.0, 0.1, 2.0, 3, 0, 0);
	...
	octahedralRotationSpinBox = createDoubleSpinBox(
		mOctahedralExtrudeLayout, octahedralRotationLabel, tr("Rotation"),
		0, 360, 1, 0.0, 3, 1, 0);
	...
	octahedralScaleSpinBox = createDoubleSpinBox(
		mOctahedralExtrudeLayout, octahedralScaleLabel, tr("Scale"),
		0.0, 10.0, 0.01, 1.0, 3, 2, 0);
	...
	octahedralSegmentsSpinBox = createDoubleSpinBox(
		mOctahedralExtrudeLayout, octahedralSegmentsLabel, tr("Segments"),
		1, 50, 1, 1, 0, 3, 0);
...
void ExtrusionsMode::setupStellateExtrude()
{
	...
	stellateLengthSpinBox = createDoubleSpinBox(
		mStellateExtrudeLayout, stellateLengthLabel, tr("Length"),
		-100.0, 100.0, 0.1, 2.0, 3, 0, 0);
...
void ExtrusionsMode::setupDoubleStellateExtrude()
{
	...
	doubleStellateLengthSpinBox = createDoubleSpinBox(
		mDoubleStellateExtrudeLayout, doubleStellateLengthLabel,
		tr("Length"), -100.0, 100.0, 0.1, 2.0, 3, 0, 0);
...
void ExtrusionsMode::setupDomeExtrude()
{
	...
	domeHeightSpinBox = createDoubleSpinBox(
		mDomeExtrudeLayout, domeHeightLabel, tr("Height:"),
	...
	domeRotationSpinBox = createDoubleSpinBox(
		mDomeExtrudeLayout, domeRotationLabel, tr("Twist:"), -1.0, 1.0, 0.01, 0.0, 3, 1, 0);
	...
	domeScaleSpinBox = createDoubleSpinBox(
		mDomeExtrudeLayout, domeScaleLabel, tr("Scale:"), 0.0, 10.0, 0.01, 1.0, 3, 2, 0);
