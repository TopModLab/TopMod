...
QDoubleSpinBox *ExperimentalMode::createDoubleSpinBox(
...
QPushButton* ExperimentalMode::addColorPreference(
	QLabel *label, QString text, QColor color,
	QGridLayout *layout, QStyle *style,
	int row, int col)
{
	label->setText(text);
...
void ExperimentalMode::setupPaintBucket()
{
	...
	mPaintBucketColorButton = addColorPreference(
		mPaintBucketColorLabel, tr("Paint Bucket\nColor:"),
		mPaintBucketColor, mPaintBucketLayout, colorPickerStyle, 0, 0);
