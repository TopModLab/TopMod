...
public:
	// Default constructor
	TMPatch()
		: patchsize(0), ctrlpts(), ctrlptnormals(), ctrlptcolors(), glctrlpts(nullptr), glctrlptcolors(nullptr)
	{
		resizePatch(4);
	}
	...
	TMPatch(const TMPatch& patch)
		...
		glctrlpts(nullptr), glctrlptcolors(nullptr)
	{
		allocateGLArray();
		populateGLArray();
	}
...
protected:
	void allocateGLArray()
	{
		...
		delete[] glctrlpts; glctrlpts = nullptr;
		delete[] glctrlptcolors; glctrlptcolors = nullptr;
		if (patchsize > 0)
		{
...
inline void TMPatch::calculatePatchPoints(
	const Vector3d& p1, const Vector3d& p2,
	const Vector3d& p3, const Vector3d& p4,
	const Vector3d& n1, const Vector3d& n2,
	const Vector3d& n3, const Vector3d& n4,
