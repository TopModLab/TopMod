...
public:
	...
	{
		for (auto fiterator = object->sel_fptr_array.begin(); fiterator != object->sel_fptr_array.end(); fiterator++)
		{
			if (fp == *fiterator)
			{
				// delete fp;
	...
	{
		for (auto it = object->sel_eptr_array.begin(); it != object->sel_eptr_array.end(); it++)
		{
			if (ep == *it)
			{
	...
	{
		for (auto it = object->sel_vptr_array.begin(); it != object->sel_vptr_array.end(); it++)
		{
			if (vp == *it)
			{
	...
	{
		for (auto it = object->sel_fvptr_array.begin(); it != object->sel_fvptr_array.end(); it++)
		{
			if (fvp == *it)
			{
	...
	void createPatchObject()
	{
		...
		{
			delete patchObject; patchObject = nullptr;
		}
