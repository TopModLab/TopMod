...
QDoubleSpinBox *HighgenusMode::createDoubleSpinBox(
...
void HighgenusMode::setupAddHoleHandle()
{
	...
	addHoleHandleNumSegmentsSpinBox = createDoubleSpinBox(
		mAddHoleHandleLayout, addHoleHandleNumSegmentsLabel, tr("# Segments"),
		1, 100, 1, 10, 0, 0, 0);
	...
	addHoleHandleNumSegmentsConnectSpinBox = createDoubleSpinBox(
		mAddHoleHandleLayout, addHoleHandleNumSegmentsConnectLabel, tr("# Segments to\nConnect (-1=all)"),
		-1, 10, 1, -1, 0, 1, 0);
	...
	addHoleHandlePinchingConnectSpinBox = createDoubleSpinBox(
		mAddHoleHandleLayout, addHoleHandlePinching, tr("Pinching"),
		-10, 10, 0.1, 1.0, 3, 2, 0);
	...
	addHoleHandlePinchingCenterConnectSpinBox = createDoubleSpinBox(
		mAddHoleHandleLayout, addHoleHandlePinchingCenter, tr("Pinch Center"),
		0, 1, 0.1, 0.5, 3, 3, 0);
	...
	addHoleHandlePinchingWidthConnectSpinBox = createDoubleSpinBox(
		mAddHoleHandleLayout, addHoleHandlePinchingWidth, tr("Pinch Width"),
		0.001, 10, 0.1, 1.0, 3, 4, 0);
...
void HighgenusMode::setupAddHoleHandleCV()
{
	...
	addHoleHandleCVNumSegmentsSpinBox = createDoubleSpinBox(
		mAddHoleHandleCVLayout, addHoleHandleCVNumSegmentsLabel, tr("# Segments"),
		1, 100, 1, 10, 0, 0, 0);
	...
	addHoleHandleCVNumSegmentsConnectSpinBox = createDoubleSpinBox(
		mAddHoleHandleCVLayout, addHoleHandleCVNumSegmentsConnectLabel, tr("# Segments to\nConnect (-1=all)"),
		0, 10, 1, -1, 0, 1, 0);
	connect(addHoleHandleNumSegmentsConnectSpinBox, SIGNAL(valueChanged(double)), this, SLOT(numSegmentsConnectValueChanged(double)));
...
void HighgenusMode::setupAddHandleSI()
{
	...
	addHandleSINumSegmentsSpinBox = createDoubleSpinBox(
		mAddHandleSILayout, addHandleSINumSegmentsLabel, tr("# Segments"),
		1, 100, 1, 10, 0, 0, 0);
	...
	addHandleSINumSegmentsConnectSpinBox = createDoubleSpinBox(
		mAddHandleSILayout, addHandleSINumSegmentsConnectLabel, tr("# Segments to\nConnect (-1=all)"),
		0, 10, 1, -1, 0, 1, 0);
	connect(
		addHoleHandleNumSegmentsConnectSpinBox, SIGNAL(valueChanged(double)),
		this, SLOT(numSegmentsConnectValueChanged(double)));
	//weight 1
	addHandleSIWeight1Label = new QLabel(this);
	addHandleSIWeight1SpinBox = createDoubleSpinBox(
		mAddHandleSILayout, addHandleSIWeight1Label, tr("Weight 1"),
		-100, 100, 0.1, 25.0, 3, 2, 0);
	...
	addHandleSIWeight2SpinBox = createDoubleSpinBox(
		mAddHandleSILayout, addHandleSIWeight2Label, tr("Weight 2"),
		-100, 100, 0.1, 25.0, 3, 4, 0);
	...
	addHandleSITwistsConnectSpinBox = createDoubleSpinBox(
		mAddHandleSILayout, addHandleSITwistsConnectLabel, tr("Extra Twists"),
		0, 100, 1, 0, 0, 5, 0);
	...
	addHandleSIPinchConnectSpinBox = createDoubleSpinBox(
		mAddHandleSILayout, addHandleSIPinchConnectLabel, tr("Pinching"),
		-10, 10, 0.1, 1.0, 3, 6, 0);
	...
	addHandleSIPinchCenterConnectSpinBox = createDoubleSpinBox(
		mAddHandleSILayout, addHandleSIPinchCenterConnectLabel, tr("Pinch Center"),
		0.001, 0.999, 0.05, 0.5, 3, 7, 0);
	...
	addHandleSIBubbleConnectSpinBox = createDoubleSpinBox(
		mAddHandleSILayout, addHandleSIBubbleConnectLabel, tr("Pinch Width"),
		0.001, 10.0, 0.1, 1.0, 3, 8, 0);
...
void HighgenusMode::setupRindModelingScaling()
{
	...
	rindModelingScalingSpinBox = createDoubleSpinBox(
		mRindModelingScalingLayout, rindModelingScalingLabel, tr("Scale"),
		0, 10.0, 0.01, 0.9, 3, 0, 0);
...
void HighgenusMode::setupRindModelingThickness()
{
	...
	rindModelingThicknessSpinBox = createDoubleSpinBox(
		mRindModelingThicknessLayout, rindModelingThicknessLabel, tr("Thickness:"),
		-1.0, 1.0, 0.01, 0.5, 3, 0, 0);
...
void HighgenusMode::setupWireframeModeling()
{
	...
	wireframeModelingThicknessSpinBox = createDoubleSpinBox(
		mWireframeModelingLayout, wireframeModelingThicknessLabel, tr("Thickness:"),
		0.0, 1.0, 0.01, 0.25, 3, 0, 0);
	connect(
		wireframeModelingThicknessSpinBox, SIGNAL(valueChanged(double)),
	...
	connect(
		wireframeSplitCheckBox, SIGNAL(stateChanged(int)),
		this, SLOT(toggleWireframeSplit(int)));
...
void HighgenusMode::setupWireframeModeling2()
{
	...
	wireframeModeling2ThicknessSpinBox = createDoubleSpinBox(
		mWireframeModeling2Layout, wireframeModeling2ThicknessLabel, tr("Thickness:"),
		0.0, 1.0, 0.01, 0.25, 3, 0, 0);
	connect(
		wireframeModeling2ThicknessSpinBox, SIGNAL(valueChanged(double)),
		((MainWindow*)mParent), SLOT(changeWireframe2Thickness(double)));
	wireframeModeling2WidthLabel = new QLabel(this);
	wireframeModeling2WidthSpinBox = createDoubleSpinBox(
		mWireframeModeling2Layout, wireframeModeling2WidthLabel, tr("Width:"),
		0.0, 1.0, 0.01, 0.25, 3, 1, 0);
	connect(
		wireframeModeling2WidthSpinBox, SIGNAL(valueChanged(double)),
		((MainWindow*)mParent), SLOT(changeWireframe2Width(double)));
...
void HighgenusMode::setupColumnModeling()
{
	...
	columnModelingThicknessSpinBox = createDoubleSpinBox(
		mColumnModelingLayout, columnModelingThicknessLabel, tr("Thickness:"),
		0.0, 1.0, 0.01, 0.25, 3, 0, 0);
	...
	columnModelingNumSegmentsSpinBox = createDoubleSpinBox(
		mColumnModelingLayout, columnModelingNumSegmentsLabel, tr("# Segments:"),
		4.0, 100, 1, 4, 0, 1, 0);
	connect(
		columnModelingNumSegmentsSpinBox, SIGNAL(valueChanged(double)),
		((MainWindow*)mParent), SLOT(changeColumnSegments(double)));
	//create column button
	columnModelingCreateButton = new QPushButton(tr("Create Columns"), this);
	connect(
		columnModelingCreateButton, SIGNAL(clicked()),
...
void HighgenusMode::setupMultiFaceHandle()
{
	...
	multiFaceHandleScaleLabel = new QLabel(this);
	multiFaceHandleScaleSpinBox = createDoubleSpinBox(
		mMultiFaceAlgorithmLayout, multiFaceHandleScaleLabel, tr("Scale Factor:"),
		0.0, 5.0, 0.01, 1.0, 3, 0, 0);
	connect(
		multiFaceHandleScaleSpinBox, SIGNAL(valueChanged(double)),
	...
	multiFaceHandleExtrudeDistanceLabel = new QLabel(this);
	multiFaceHandleExtrudeDistanceSpinBox = createDoubleSpinBox(
		mMultiFaceAlgorithmLayout, multiFaceHandleExtrudeDistanceLabel, tr("Extrude Dist.\nFactor:"),
		-2.0, 2.0, 0.1, 0.5, 3, 1, 0);
	connect(
		multiFaceHandleExtrudeDistanceSpinBox, SIGNAL(valueChanged(double)), 
	...
	connect(
		multiFaceHandleMaxOffsetsCheckBox, SIGNAL(stateChanged(int)),
	...
	connect(
		multiFaceHandleButton, SIGNAL(clicked()),
...
void HighgenusMode::setupMengerSponge()
{
	...
	mengerSpongeThicknessSpinBox = createDoubleSpinBox(
		mMengerSpongeLayout, mengerSpongeThicknessLabel, tr("Thickness:"),
		0.01, 1.0, 0.01, 0.67, 3, 0, 0);
	connect(
		mengerSpongeThicknessSpinBox, SIGNAL(valueChanged(double)),
		((MainWindow*)mParent), SLOT(changeMengerSpongeThickness(double)));
	//threshold
	mengerSpongeThresholdLabel = new QLabel(this);
	mengerSpongeThresholdSpinBox = createDoubleSpinBox(
		mMengerSpongeLayout, mengerSpongeThresholdLabel, tr("Edge Collapse\nThreshold Factor:"),
		0.0, 10.0, 0.1, 0.0, 3, 1, 0);
	connect(
		mengerSpongeThresholdSpinBox, SIGNAL(valueChanged(double)),
	...
	connect(
		mengerSpongFractionalThicknessCheckBox, SIGNAL(stateChanged(int)),
	...
	connect(
		mengerSpongeButton, SIGNAL(clicked()),
